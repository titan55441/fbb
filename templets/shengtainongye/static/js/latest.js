    ...
    var browsers = [
        {
            ...
            'durl' : 'https://qqbrowser-1251013107.file.myqcloud.com/QQBrowser_subid@100002_urlid@100002.exe'
        }
    ];
    ...
    '<div id="iealertwn"><div class="iealwn-wrap"><div class="iealwn-box"><div class="iealwn-main">\
        ...
        <div class="iealwn-notice">\
            ...
            <div id="_iealwn_browserAlert">\
                ...
                <p>如您坚持使用当前浏览器访问本站，你将看到排版错误、功能不全、无法正常使用的网页，甚至是满屏乱码。请至少升级至 IE' + (_iealwn.outver+1) + ' 或使用更先进的浏览器再访问。</p>\
            </div>\
            <div id="_iealwn_browserAlert_new">' + currentBrowserHtml + '</div>\
            <div class="iealwn-title iealwn-title_browser">下载更先进的浏览器</div>\
            <div id="iealwn-browsers">'+
                browsersHtml + 
                '<div class="iealwn-browser-clear"></div>\
            </div>\
            <div class="iealwn-title iealwn-title_faq">为什么会出现这个弹窗？</div>\
            <p>如果你不知道升级浏览器是什么意思，请请教一些熟练电脑操作的朋友。如你是网站技术人员，请加入旧版 Internet Explorer 淘汰行动。<a href="https://support.dmeng.net/kill-old-versions-of-ie.html" target="_blank">了解详情</a></p>\
        </div>\
        <div class="iealwn-line">\
